...
sudo systemctl status grafana-server   these my remd.md document proper how to setup garfan promethou in aws ec2 inatsnce write a proper ned to end document